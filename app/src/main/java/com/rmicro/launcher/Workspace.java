...
import com.rmicro.launcher.Utils.AppsDeskManager;
import com.rmicro.launcher.Utils.Cell;
import com.rmicro.launcher.Utils.CellLayout;
import com.rmicro.launcher.receiver.AppInstallReceiver;
import com.rmicro.launcher.view.PagedViews;

import static com.rmicro.launcher.Utils.LogUtils.LOGD;
...
//		DB.log("add column : "+col+",w="+mPageWidth+",h="+mPageHeight);
	...
	void addCell(Cell cell){
		...
		if (mAllCellLayout.containsKey(cell.mItemInfo.screen + "-" + 0))
			...
			LOGD(TAG," celllayout in not enough for cell: "+cell);
		if(cl !=null){
			cl.addView(cell);
		}
	}
